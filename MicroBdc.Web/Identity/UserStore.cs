...
using Entities = MicroBdc.Entities.Identity;

namespace MicroBdc.Web.Identity
{
    public class UserStore : IUserLoginStore<IdentityUser, Guid>, IUserClaimStore<IdentityUser, Guid>, IUserRoleStore<IdentityUser, Guid>, IUserPasswordStore<IdentityUser, Guid>, IUserSecurityStampStore<IdentityUser, Guid>, IUserStore<IdentityUser, Guid>, IDisposable
    {
        ...
        public UserStore(IAuthUnitOfWork unitOfWork)
        {
        ...
        public Task AddClaimAsync(IdentityUser user, Claim claim)
        {
            ...
            var c = new Entities.Identity.Claim
            {
        ...
        public Task AddLoginAsync(IdentityUser user, UserLoginInfo login)
        {
            ...
            var l = new Entities.Identity.ExternalLogin
            {
        ...
        private Entities.Identity.User getUser(IdentityUser identityUser)
        {
            if (identityUser == null)
                return null;

            var user = new Entities.Identity.User();
            populateUser(user, identityUser);

            return user;
        }

        private void populateUser(Entities.Identity.User user, IdentityUser identityUser)
        {
        ...
        private IdentityUser getIdentityUser(Entities.Identity.User user)
        {
            if (user == null)
                return null;
        ...
        private void populateIdentityUser(IdentityUser identityUser, Entities.Identity.User user)
        {
